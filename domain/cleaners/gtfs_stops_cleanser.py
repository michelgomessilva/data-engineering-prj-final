...
def cleanse_gtfs_stops_df(spark: SparkSession, input_path: str) -> DataFrame:
    """
    Realiza o cleansing do dataset gtfs_stops a partir dos dados raw em Parquet.
    ...
    Args:
        ...
        input_path (str): Caminho no GCS para o arquivo Parquet de gtfs_stops.
